...
%       (§\ref{sec:import_leakage}, contra CMdG France).
%
...
% ----------------------------------------------------------------
% 6.2  WHY BELGIUM DIFFERS FROM CMdG'S FRANCE
% ----------------------------------------------------------------
...
%
%   - Identification timing. CMdG's window includes the 2005–08 free-allocation
%     era and the 2013+ scarcity era together; Belgian shock is concentrated
%     in Phase IV (2021+) and therefore largely outside CMdG's window.
...
% TODO:
%   - Phase IV identification: CPShock fails (macro contamination); CMdG
