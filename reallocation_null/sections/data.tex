...
\]
on the 2001--2022 annual NACE 4-digit panel with sector-specific linear trends $\theta_s \cdot t$. Phase-aggregated coefficients (CdGM-tight treatment of seven NACE 2-digit codes, the same set as in their Table A.5):
\[
